...
public class ForComprehension5<T1, T2, T3, T4, T5> {
                        ...
                        return xs3.flatMap(new FlatMapF1<T3, U>() {
                            public CollectionLike<U> apply(final T3 t3) {
                                return xs4.flatMap(new FlatMapF1<T4, U>() {
                                    public CollectionLike<U> apply(final T4 t4) {
                                        return xs5.map(new F1<T5, U>() {
                                            public U apply(T5 t5) throws Exception {
                                                return f.apply(Tpl.apply(t1, t2, t3, t4, t5));
                                            }
                                        });
                                    }
                                });
    ...
    public void apply(final VoidFunction1<Tuple5<T1, T2, T3, T4, T5>> f) {
                        ...
                        xs3.foreach(new VoidF1<T3>() {
                            public void apply(final T3 t3) {
                                xs4.foreach(new VoidF1<T4>() {
                                    public void apply(final T4 t4) {
                                        xs5.foreach(new VoidF1<T5>() {
                                            public void apply(T5 t5) throws Exception {
                                                f.apply(Tpl.apply(t1, t2, t3, t4, t5));
                                            }
                                        });
                                    }
                                });
