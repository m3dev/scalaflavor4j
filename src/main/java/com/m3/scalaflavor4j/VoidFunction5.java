 ...
 */
public abstract class VoidFunction5<T1, T2, T3, T4, T5> {
     ...
     */
    public abstract void _(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5) throws Exception;
    ...
    public VoidFunction1<Tuple5<T1, T2, T3, T4, T5>> tupled() {
        final VoidFunction5<T1, T2, T3, T4, T5> _this = this;
        return new VoidF1<Tuple5<T1, T2, T3, T4, T5>>() {
            public void _(Tuple5<T1, T2, T3, T4, T5> tuple) throws Exception {
